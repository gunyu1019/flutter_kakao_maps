...
void main() {
  ...
  group('Marker Mocking Tests', () {
    test('addPoiStyle returns style id from overlay channel response', () async {
    ...
    test('addBadge returns Badge with id from overlay channel response', () async {
      final style = PoiStyle(
        id: 'poi-style-badge',
  ...
  group('Polyline Mocking Tests', () {
    test('addPolylineShapeStyle returns style id from channel response', () async {
      ...
      final styleId = await controller.addPolylineShapeStyle(style, PolylineCap.round);

      expect(styleId, 'polyline-style-explicit-id');
      expect(style.id, 'polyline-style-explicit-id');
    });

    test('addPolylineShape returns Polyline with id from channel response', () async {
      final style = PolylineStyle(
  ...
  group('Polygon Mocking Tests', () {
    test('addPolygonShapeStyle returns style id from channel response', () async {
    ...
    test('addPolygonShape returns Polygon with id from channel response', () async {
      final style = PolygonStyle(
  ...
  group('Route Mocking Tests', () {
    ...
    test('addMultipleRoute returns MultipleRoute with id and segment mapping', () async {
      final style = RouteStyle(
      ...
      final option = MultipleRouteOption([style], id: 'multi-route-explicit-id')
        ..addRouteWithIndex(
