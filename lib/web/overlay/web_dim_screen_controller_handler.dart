...
mixin WebDimScreenControllerHandler {
  ...
  Future<dynamic> dimScreenHandle(MethodCall method) async {
    ...
    switch (method.method) {
      ...
      case "addHighlightPolygonShape":
        ...
        return await addHighlightPolygonShape(point, id: polygon["id"]);
      ...
      case "changePolygon":
        ...
        await changePolygon(shapeId, point);
        return;
      default:
  ...
  Future<String> addHighlightPolygonShape(WebShapePoint point, {String? id});

  Future<void> removeHighlightPolygonShape(String shapeId);

  Future<void> changePolygonVisible(String shapeId, bool visible);

  Future<void> changePolygon(String shapeId, WebShapePoint point);
}
